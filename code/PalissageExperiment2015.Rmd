---
title: "Palissage experiment - een poging om de groei van okselscheuten te remmen"
author: "Bart van Hest"
date: "22 januari 2017"
...
### Druivenrassen
Twee Druivenrassen, [Marechal Foch](http://www.brabantsewijnbouwers.nl/index.php?section=13&page=37&student=594) en [Solaris](http://www.brabantsewijnbouwers.nl/index.php?section=13&page=133&student=409), werden voor mijn experiment gekozen op basis van hun sterke groei en nijging om okselscheuten en een dichte loofwand te ontwikkelen. Beide rassen groeien op [SO4 onderstammen](http://iv.ucdavis.edu/Viticultural_Information/?uid=177&ds=351).
...
![figuur 1. Het neerslagtekort voor 2015, vergeleken met de mediaan en extreme jaren.](../images/fig1_neerslagtekort2015.png)
...
![figuure . De Huglin-index gedurende het groeiseizoen van 2015 (bron: metingen Bart van Hest, klimaat-data van het KNMI)](../images/fig2_HuglinIndex_BBCH_2015.png)
...
*Opmerkingen en observaties:*
  ...
  - het aantal en de lengte van de okselscheuten was op dit moment als groot. Daarom was het nodig om aanvullend de okselscheuten in de fruitzone te verwijderen of terug te snoeien op 1 blad.

De volgende foto's tonen de rijen voorafgaand en na de snoei/wikkel activiteiten.

variëteit | voor | na
----- | ---- | -----
M.Foch | ![](../images/foto1_MFoch_voor_snoei.png) | ![](../images/foto2_MFoch_na_snoei.png)
Solaris | ![](../images/foto3_Solaris_voor_snoei.png) | ![](../images/foto4_Solaris_na_snoei.png)

Een close-up van de gewikkelde Marechal Foch:
![Foto 5. close-up van de gewikkelde Marechal Foch.](../images/foto5_MFoch_close-up.png)
...
----- | ---- | -----
M.Foch | ![](../images/foto6_MFoch_snoeiafval.png) | ![](../images/foto7_MFoch_wikkelafval.png)
...
methode	| observaties
------- | -----------------------------------------------------------------------------------------------------
topsnoei	| langere okselscheuten, met lengtes tot 70-100cm. Toch is de loofwand nog relatief open. Geen ziektes in het blad of op de druiven.
...
methode	| observaties
------- | -----------------------------------------------------------------------------------------------------
topsnoei	| minder lange topscheuten dan bij de M.Foch, iets meer okselscheuten dan bij de gewikkelde rijen. Minder duidelijk verschil dan bij de M.Foch. Redelijk open loofwand. Geen ziektes.
...
*Opmerkingen en observaties:*
  ...
  - door de toegenomen neerslag was het noodzakelijk om de loofwand openen te maken door de naar beneden groeiende/hangende topscheuten te snoeien.
...
Het doorbuigen van de topdraad is duidelijk zichtbaar.


type | voor | na
----- | ---- | -----
Topsnoei | ![](../images/foto8_MFoch_voor_snoei_aug.jpg) | ![](../images/foto9_MFoch_na_snoei_aug.jpg)
Wikkelen | ![](../images/foto10_MFoch_voor_wikkelen_aug.jpg) | ![](../images/foto11_MFoch_na_wikkelen_aug.jpg)
...
variëteit | snoei | wikkelen
----- | ---- | -----
M.Foch | ![](../images/foto12_MFoch_zijscheut_snoei_aug.jpg) | ![](../images/foto13_MFoch_zijscheut_wikkelen_aug.jpg)
Solaris | ![](../images/foto14_Solaris_zijscheut_snoei_aug.jpg) | ![](../images/foto15_Solaris_zijscheut_wikkelen_aug.jpg)

De foto's van de getopte en gewikkelde topdraad van de rijen met Solaris tonen een dichtere loofwand in de top van de gewikkelde rijen. De foto's zijn genomen vanaf dezelfde hoogte en onder dezelfde hoek, maar in tegenstelde richting met betrekking tot de positie van de zon, wat resulteerde in wat vreemde kleuren. 

variëteit | snoei | wikkelen
----- | ---- | -----
Solaris | ![](../images/foto16_Solaris_top_snoei_aug.jpg) | ![](../images/foto17_Solaris_top_wikkelen_aug.jpg)

In de meeste jaren moet zowel bij de Marechal Foch als de Solaris minstens twee, maar meestal drie keer worden getopt en okselscheuten worden verwijderd. Tijdens dit experiment werd het toppen iets uitgesteld in de verwachting dat een groter verschil zou worden gevonden tussen de getopte en gewikkelde rijen.

Vanaf half augustus begon de rijping en nam de groei af.
...
21-7 | Scala | 2ml/L | preventief tegen tros-botrytis (toegepast bij BBCH 77 - sluiten trossen).
...
Er zijn gedurende het groeiseizoen geen ziektes aangetroffen op de Solaris and Marechal Foch. De Golubok en Johanniter vertoonden een lichte aantasting door zwartrot. De Golubok vertoonde ook een lichte aantasting door Peronospera op de jonge bladeren.


## Resultaten

Er wordt onderscheid gemaakt tussen de uitkomsten in de wijngaard en in de wijnkelder, omdat het werk in de wijngaard uiteindelijk tot doel heeft om gezonde en rijpe druiven te krijgen voor het maken van wijn.
...
De belangrijkste observaties zijn;
  ...
  - hoewel geen ziektes werden aangetroffen gedurende de periode van het experiment, baart de dichte loofwand als gevolg van het wikkelen zorgen.
...
Het was leuk om mee te werken aan een dergelijk wijnbouw experiment en een seizoen nog meer dan gebruikelijk de ontwikkeling van de druivenstokken bij te houden. Ik weet daarom zeker dat ik in de toekomst nieuwe experimenten zal uitvoeren.  
( :) ).


## Voorlopige conclusies Cornel University

Cornel University had zelf twee proefwijngaarden ter beschikking, Long Island en King Ferry. In de eeste wijngaard werd enkel het willen rond de topdraad toegepast, in de andere wijngaard werd daarnaast in een derde rij de topscheut naar beneden uitgebogen zodat een soort boog ontstond.  
...
Onderstaande foto's tonen de twee toegepaste methoden van palissage bij topscheuten die nog minder ver zijn ontwikkeld in vergelijking met mijn experiment. NB op basis van de foto's denk ik ook dat dit minder groeikrachtige druivenrassen zijn dan die van mij.

wikkelen | naar beneden uitbuigen
---- | -----
![](../images/fig4_cornelUni_palissage.png) | ![](../images/fig5_cornelUni_palissage.png)
...
---- | -----
![](../images/fig1_cornelUni_palissage.png) | ![](../images/fig2_cornelUni_palissage.png)
...
Verder merken zij op dat het optreden van schimmelziekten in de loofwand een zorg (concern) is.
...
![](../images/fig3_cornelUni_palissage.png)
